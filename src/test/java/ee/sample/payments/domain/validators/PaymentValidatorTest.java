...
class PaymentValidatorTest {
  ...
  void isValid_happyPaths() {
    Assertions.assertTrue(
      new PaymentValidator(makePayment("EUR",1,PaymentType.TYPE_1).details("details present")).isValid());
    Assertions.assertTrue(
  ...
  void isValid_nonHappyPaths() {
    Assertions.assertFalse(
      new PaymentValidator(makePayment("EUR",1,PaymentType.TYPE_1).details(null)).isValid());
